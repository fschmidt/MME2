...
[ExcludeClass]
public class _IsoSandbox_mx_managers_SystemManager
    ...
    implements IFlexModuleFactory, ISWFContext
{
    ...
    public function _IsoSandbox_mx_managers_SystemManager()
    {
    ...
    override     public function create(... params):Object
    {
        ...
        var mainClassName:String = params.length == 0 ? "application.IsoSandbox" : String(params[0]);
...
,
            ...
            layout: "vertical",
            mainClassName: "application.IsoSandbox",
            minHeight: "600",
            minWidth: "955",
            mixins: [ "_IsoSandbox_FlexInit", "_IsoSandbox_Styles" ],
            placeholderRsls: [
