...
[ExcludeClass]
public class _Consilio_mx_managers_SystemManager
    ...
    implements IFlexModuleFactory, ISWFContext
{
    ...
    public function _Consilio_mx_managers_SystemManager()
    {
    ...
    override     public function create(... params):Object
    {
        ...
        var mainClassName:String = params.length == 0 ? "Consilio" : String(params[0]);
...
,
            ...
            layout: "vertical",
            mainClassName: "Consilio",
            minHeight: "768",
            minWidth: "1024",
            mixins: [ "_Consilio_FlexInit", "_Consilio_Styles" ],
            placeholderRsls: [
