...
[ExcludeClass]
public class application_IsoSandboxApp_mx_managers_SystemManager
    ...
    implements IFlexModuleFactory, ISWFContext
{
    ...
    public function application_IsoSandboxApp_mx_managers_SystemManager()
    {
    ...
    override     public function create(... params):Object
    {
        ...
        var mainClassName:String = params.length == 0 ? "application.IsoSandboxApp" : String(params[0]);
...
,
            ...
            mainClassName: "application.IsoSandboxApp",
            mixins: [ "_IsoSandboxApp_Styles" ],
            placeholderRsls: [
