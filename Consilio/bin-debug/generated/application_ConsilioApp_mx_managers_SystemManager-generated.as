...
[ExcludeClass]
public class application_ConsilioApp_mx_managers_SystemManager
    ...
    implements IFlexModuleFactory, ISWFContext
{
    ...
    public function application_ConsilioApp_mx_managers_SystemManager()
    {
    ...
    override     public function create(... params):Object
    {
        ...
        var mainClassName:String = params.length == 0 ? "application.ConsilioApp" : String(params[0]);
...
,
            ...
            mainClassName: "application.ConsilioApp",
            mixins: [ "_ConsilioApp_Styles" ],
            placeholderRsls: [
