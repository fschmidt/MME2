...
[ExcludeClass]
public class _MyTest_mx_managers_SystemManager
    ...
    implements IFlexModuleFactory, ISWFContext
{
    ...
    public function _MyTest_mx_managers_SystemManager()
    {
    ...
    override     public function create(... params):Object
    {
        ...
        var mainClassName:String = params.length == 0 ? "MyTest" : String(params[0]);
...
,
            ...
            minHeight: "600",
            minWidth: "955",
            mixins: [ "_MyTest_FlexInit", "_MyTest_Styles" ],
            placeholderRsls: [
