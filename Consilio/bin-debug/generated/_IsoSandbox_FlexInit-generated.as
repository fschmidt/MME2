...
[Mixin]
public class _IsoSandbox_FlexInit
{
   public function _IsoSandbox_FlexInit()
   {
       super();
   }
   public static function init(fbs:IFlexModuleFactory):void
   {
           ...
           { 
               ...
               { 
                   trace(ResourceManager.getInstance().getString( "core", 
                         ...
                         ["mx.utils.ObjectProxy","application:IsoSandbox","_IsoSandbox_FlexInit"]));
               } 
           } 
       } 
       catch (e:Error) 
       ...
       var styleNames:Array = ["lineHeight", "unfocusedTextSelectionColor", "kerning", "showErrorSkin", "textRollOverColor", "digitCase", "inactiveTextSelectionColor", "listAutoPadding", "textDecoration", "showErrorTip", "justificationRule", "dominantBaseline", "fontThickness", "trackingRight", "textShadowColor", "blockProgression", "leadingModel", "listStylePosition", "textAlignLast", "textShadowAlpha", "textAlpha", "letterSpacing", "chromeColor", "rollOverColor", "fontSize", "focusedTextSelectionColor", "baselineShift", "paragraphEndIndent", "fontWeight", "breakOpportunity", "leading", "renderingMode", "symbolColor", "fontSharpness", "barColor", "modalTransparencyDuration", "paragraphStartIndent", "justificationStyle", "layoutDirection", "wordSpacing", "listStyleType", "footerColors", "contentBackgroundColor", "paragraphSpaceAfter", "contentBackgroundAlpha", "textRotation", "fontAntiAliasType", "direction", "errorColor", "cffHinting", "locale", "backgroundDisabledColor", "digitWidth", "modalTransparencyColor", "ligatureLevel", "touchDelay", "firstBaselineOffset", "textIndent", "clearFloats", "themeColor", "tabStops", "modalTransparency", "fontLookup", "paragraphSpaceBefore", "headerColors", "textAlign", "fontFamily", "textSelectedColor", "lineThrough", "interactionMode", "whiteSpaceCollapse", "fontGridFitType", "alignmentBaseline", "trackingLeft", "fontStyle", "dropShadowColor", "accentColor", "disabledColor", "modalTransparencyBlur", "downColor", "textJustify", "focusColor", "color", "alternatingItemColors", "typographicCase"];
